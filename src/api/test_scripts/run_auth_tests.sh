...
# Auth Routes Test Runner
# This script runs the auth routes test suite

set -e

echo "🔧 Auth Routes Test Runner"
echo "=========================="

# Check if we're in the right directory
if [ ! -f "test_auth_routes.py" ]; then
    echo "❌ Error: test_auth_routes.py not found in current directory"
...
# Run the tests
echo ""
echo "🚀 Running Auth Routes Tests..."
echo "================================"
