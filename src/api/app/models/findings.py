...
class TyposquatDomain(BaseModel):
    ...
    recordedfuture_data: Optional[Dict[str, Any]] = None
    ...
    # Auto-resolve flag: true when finding meets program thresholds
    ...
    @classmethod
    def validate_jsonb_fields(cls, v):
        """Convert string 'null' to None for JSONB fields"""
        if v == "null":
            return None
        return v
...
class BrokenLink(BaseModel):
    ...
    reason: Optional[str] = None  # Reason for broken link (for general)
    status: str  # valid, broken, error, throttled
    url: Optional[str] = None
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={
            "example": {
                ...
                "media_type": "facebook",
                "status": "broken",
                "url": "https://facebook.com/example_account",
                "error_code": "400",
                "response_data": {"status_code": 400},
                "checked_at": "2023-01-01T00:00:00",
                "notes": "User notes about this broken link",
                "created_at": "2023-01-01T00:00:00",
                "updated_at": "2023-01-01T00:00:00"
            }
        }
...
class BrokenLinkSearchRequest(BaseModel):
    ...
    link_type: Optional[str] = Field(None, description="Filter by link type (social_media or general)")
    media_type: Optional[str] = Field(None, description="Filter by media type")
    status: Optional[str] = Field(None, description="Filter by status")
    domain_search: Optional[str] = Field(None, description="Search within domain names")
    sort_by: Optional[str] = Field("checked_at", description="Sort field")
