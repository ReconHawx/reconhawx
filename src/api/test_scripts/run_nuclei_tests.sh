...
# Nuclei Findings Routes Test Runner
# This script runs the nuclei findings routes test suite

set -e

echo "🔍 Nuclei Findings Routes Test Runner"
echo "====================================="

# Check if we're in the right directory
if [ ! -f "test_nuclei_routes.py" ]; then
    echo "❌ Error: test_nuclei_routes.py not found in current directory"
...
# Run the tests
echo ""
echo "🚀 Running Nuclei Findings Routes Tests..."
echo "=========================================="

python3 test_nuclei_routes.py
