...
# Subdomain Routes Test Runner
# This script runs the subdomain routes test suite

set -e

echo "🔧 Subdomain Routes Test Runner"
echo "==============================="

# Check if we're in the right directory
if [ ! -f "test_subdomain_routes.py" ]; then
    echo "❌ Error: test_subdomain_routes.py not found in current directory"
...
# Run the tests
echo ""
echo "🚀 Running Subdomain Routes Tests..."
echo "===================================="

python3 test_subdomain_routes.py
