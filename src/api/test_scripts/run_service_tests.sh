...
# Service Routes Test Runner
# This script runs the service routes test suite

set -e

echo "🔧 Service Routes Test Runner"
echo "============================="

# Check if we're in the right directory
if [ ! -f "test_service_routes.py" ]; then
    echo "❌ Error: test_service_routes.py not found in current directory"
...
# Run the tests
echo ""
echo "🚀 Running Service Routes Tests..."
echo "=================================="

python3 test_service_routes.py
